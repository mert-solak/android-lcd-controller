 ...
 */
public final class NewsEntryAdapterForProgram extends ArrayAdapter<NewsEntry> {

    private final int newsItemLayoutResource;

    public NewsEntryAdapterForProgram(final Context context, final int newsItemLayoutResource) {
        super(context, 0);
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        viewHolder.subTitleView.setTextColor(Color.parseColor("#FF0FEFDD"));
